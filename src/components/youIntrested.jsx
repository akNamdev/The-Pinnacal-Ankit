...
export default function YouIntrested() {
    const [openModal, setOpenModal] = useState(false);
    return (
        <>
            {/* Section */}
            <div className="max-w-full w-full bg-[#173F63] my-6 py-6 px-6 text-white flex flex-col md:flex-row items-center justify-between gap-6 md:gap-[200px]">
                ...
                <Button
                    ...
                    className="w-[200px] md:w-[258.87px] h-[45px] text-[#173F63] p-1  font-extrabold bg-[white] rounded-full"
                >
